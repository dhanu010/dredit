/*class that handles the reading and writing of the spreadhseet*/
package edu.csus.dredit.model;
...
public class SpreadsheetHandler {
	...
	public void addNewPaymentInfo(String date,String payment, String balance, String apr)
throws MalformedURLException, IOException, ServiceException
	{
		/*TODO: */
		System.out.println("Going to add the info");
		
		WorksheetEntry myWorksheet = getCreditCardWorksheet(this.getSpreadsheetTitle(), "Sheet1", this.getSpreadsheetService());
		if(myWorksheet == null)
		{
